...
/// @title ZiSK SNARK Plonk Verifier (auto-generated by snarkJS)
/// @dev Low-level Groth16/Plonk proof verification for ZiSK proofs.
contract ZiskSnarkPlonkVerifier {
    // Omega
    ...
    uint256 constant Qmx  = 13259746521093805798135066461248742813614843439576290460064582730857951606351;
    uint256 constant Qmy  = 14865971826587743162270796026766973238262745325716152973837127955371928062887;
    uint256 constant Qlx  = 14299807127877167125298875616067996480466851414558117299666220707496939741097;
    uint256 constant Qly  = 3830735882965136769584848739107988926433057988845937765162750399424804652641;
    uint256 constant Qrx  = 15785058744125278425228920105899189812786633424232418349155975111478652998561;
    uint256 constant Qry  = 18464215534946041478734381417587395955788129449203670205604953367221493667240;
    uint256 constant Qox  = 15565649230524958385252256291775531396256668369075888367804989866563982636744;
    uint256 constant Qoy  = 6649666289843266247730531704157143709409305305005140001762727280688075731617;
    uint256 constant Qcx  = 11820534339849288331563812695607297805486752869358215661470740132241087560706;
    uint256 constant Qcy  = 13966172050880515959153810943800659966908532521335491289366836524304952154421;
    uint256 constant S1x  = 20032663236040468293970415675515175444486692199784782908716983996748674577056;
    uint256 constant S1y  = 19169141969164681654818307722954983992411514235427262836030708683920342662611;
    uint256 constant S2x  = 19509156676652712620507023756490311717509818555687366889149667969896747301033;
    uint256 constant S2y  = 16709413601401061533785611534859380014344692989831845088176460087134098608095;
    uint256 constant S3x  = 6160964354589946656913563041002867578787185247897231417208000123712266139094;
    uint256 constant S3y  = 10069569319972923456234137725092689235594667486884983045820235354067198093535;
